...
TARGET_COLUMN = "rain_next_24h"
MODEL_DIR = Path(__file__).with_name("trained_models")
MODEL_NAME = "bkk_rain_next_24h_v3_hist_gradient_boosting"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train a V3 Bangkok rain/no-rain model for the next 24 hours."
    )
